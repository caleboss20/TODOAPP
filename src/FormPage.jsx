    ...
    bg-white flex flex-col">
      ...
      <div className="w-full overflow-hidden flex-1">
        <div
          ...
          style={{ transform: tab === "signup" ? "translateX(-50%)" : "translateX(0%)" }}
        >
          {/* ---- SIGN IN FORM ---- */}
          ...
          pt-6 flex flex-col gap-4">
            ...
            <div className="flex justify-center gap-5">
              <button className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center text-blue-600 font-bold text-lg">f</button>
              <button className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center font-bold text-lg">G</button>
              <button className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center text-lg">🍎</button>
            </div>
          </div>
          {/* ---- SIGN UP FORM ---- */}
          <div className="w-1/2 px-8 pt-6 flex 
          flex-col gap-4 pb-5">
            <input
              type="text"
            ...
            <div className="flex justify-center gap-5">
              <button className="w-12 h-12 rounded-full
               border border-gray-200 flex
                items-center justify-center 
                text-blue-600 font-bold text-lg">f</button>
              <button className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center font-bold text-lg">G</button>
              <button className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center text-lg">🍎</button>
            </div>
          </div>
